...
## Push Notifications (privado)
Rutas para registrar token FCM y enviar notificación de prueba al usuario autenticado.
...
### POST /devices/token
- Auth: Sí
- Alias de compatibilidad de `/push/token`.
- Request/Response iguales.
...
{
  "title": "Recordatorio",
  "body": "Tienes clase en 10 minutos",
  "data": { "screen": "horarios" }
}
```
- Response 200 JSON:
```json
